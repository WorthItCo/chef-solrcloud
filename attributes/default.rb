...
default['solrcloud']['version']       = '4.10.3'
...
default['solrcloud']['solr_config']['solrcloud']['zk_host']            = node[:opsworks][:layers]['zookeeper'][:instances].map{|name, h| "#{h[:private_ip]}:2181" } # Syntax: ["zkHost:zkPort"]
